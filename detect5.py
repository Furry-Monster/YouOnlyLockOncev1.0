...
# 自定义库
from captureScreen import capScreen

from models.experimental import attempt_load
from utils.datasets import letterbox
from utils.utils import *

from my_ctypes import SendInput, mouse_input
...
class YouOnlyLockOnce:
    ...
    def run(self):
        ...
        while True:
            ...
            # 取距离最近的一个
            move_mouse(mouse_control, aim_persons_center)
            aim_persons_center = []
            aim_persons_center_head = []
...
def parseArgs():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='weights/cs2_200.pt', help='model.pt path(s)')
...
if __name__ == '__main__':
    ...
    yolo = YouOnlyLockOnce(opt)
    print('The Yolo Object Created.')
